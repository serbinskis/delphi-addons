...
uses
  ...
  TntClasses, TntForms, TntSysUtils, Graphics;
...
function WideInputQuery(const ACaption, APrompt: WideString;
   var Value: WideString; AFont: TFont): Boolean;
{TNT-WARN InputBox}
function WideInputBox(const ACaption, APrompt, ADefault: WideString; AFont: TFont): WideString;
...
uses
  Controls, Forms, Types, SysUtils, Consts, Math,
...
function WideInputQuery(const ACaption, APrompt: WideString; var Value: WideString; AFont: TFont): Boolean;
var
  Form: TTntForm;
  Prompt: TTntLabel;
  Edit: TTntEdit;
...
begin
  Result := ADefault;
  WideInputQuery(ACaption, APrompt, Result, AFont);
end;
