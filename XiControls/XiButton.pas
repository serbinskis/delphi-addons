...
type
  ...
  TColorScheme = (csNeoDesert, csNeoSky, csNeoGrass, csNeoSilver,
       csNeoRose, csNeoSun,
       csDesert, csGrass, csSky, csSun, csRose, csSilver, csFlatStyle, csCustom);
...
begin
  ...
  if FFocused and (FColorFocusRect <> clNone) then begin
...
begin
  ...
  csFlatStyle:   begin
                   ...
                   OverColorBorder:= $D77800;
                   OverColorText:= clBlack;
                   DownColorFace:= $F0F0F0;
                   DownColorGrad:= $F0F0F0;
                   DownColorLight:= $F0F0F0;
                   DownColorDark:= $F0F0F0;
                   DownColorBorder:= $995400;
                   DownColorText:= clBlack;
                   DisabledColorFace:= $C0C0C0;
                   DisabledColorGrad:= $C0C0C0;
                   DisabledColorLight:= $C0C0C0;
                   DisabledColorDark:= $C0C0C0;
