...
type
  ...
  private
    ...
    FTimerDelay: Integer;
    FDisableMarks: Boolean;

    FColorBorder: TColor;
    FColorRectArrow: TColor;
    FColorRectThumb: TColor;
    FColorFillArrow: TColor;
    FColorFillThumb: TColor;
    FColorArrow: TColor;
  ...
  published
    ...
    property DisableMarks: Boolean read FDisableMarks write FDisableMarks;
    property ColorBorder: TColor read FColorBorder write FColorBorder;
    property ColorRectArrow: TColor read FColorRectArrow write FColorRectArrow;
    property ColorRectThumb: TColor read FColorRectThumb write FColorRectThumb;
    property ColorFillArrow: TColor read FColorFillArrow write FColorFillArrow;
    property ColorFillThumb: TColor read FColorFillThumb write FColorFillThumb;
    property ColorArrow: TColor read FColorArrow write FColorArrow;
    property ColorScrolled: TColor read FColorScrolled write FColorScrolled;
...
begin
  ...
  FColorArrow:= $404040;
  FColorRectArrow:= $808080;
  FColorRectThumb:= $808080;
  FColorFillArrow:= $c0c0c0;
  FColorFillThumb:= $c0c0c0;
...
var
  ...
  cc: Integer;
begin
  C.Brush.Color:= FColorRectArrow;
  C.FillRect(R);

  InflateRect(R, -1, -1);
  C.Brush.Color:= FColorFillArrow;
  C.FillRect(R);
...
var
  P: TPoint;
begin
  C.Brush.Color:= FColorFillThumb;
  C.Pen.Color:= FColorRectThumb;
  C.Rectangle(R);

  if FDisableMarks then Exit;
