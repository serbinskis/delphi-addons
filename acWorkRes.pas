...
************************************************************************
  Модуль:   acWorkRes.pas
  Описание: Доработанный модуль madRes.pas входящий в библиотеку компании
            Mathias Rauen. Доработка заключается в возможности работать
            с ресурсами Icon и Bitmap без явного задания языка ресурса
  Автор:    Сальников А.А.
  Версия:   1.01.02  11.04.04
            - Добавлена функция "GetNameIcon" - Функция возвращает наз-
              вание иконки по ее номеру
            1.00.01  09.04.04
            - Создан модуль
************************************************************************)

// ***************************************************************
//  madRes.pas                version:  1.0g  ·  date: 2004-03-08
//  -------------------------------------------------------------
...
////////////////////////////////// Alx ///////////////////////////
var
  notLang: Boolean = False; // Отключение проверки языка в ресурсе
                            // Целесообразно применять к иконкам и
                            // рисункам т. к. эти типы ресурсов в
                            // 99.99% случаев одного языка
...
// Функция возвращает название иконки по ее номеру
