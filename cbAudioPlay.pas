...
type
  ...
  public
    constructor Create(const Parent: TWinControl; const FileName: WideString;
      DeviceIndex: Integer);
...
constructor TcbAudioPlay.Create(const Parent: TWinControl;
  const FileName: WideString; DeviceIndex: Integer);
var
  AudR: IBaseFilter;
  mt: TAM_MEDIA_TYPE;
begin
  ...
  SCheck( FGraph.RenderFile(PWideChar(FileName), nil) );
